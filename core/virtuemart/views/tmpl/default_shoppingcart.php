...
<tr>
    ...
    <th align="right" class="col-total" colspan="1" style="text-align: center"><?php echo vmText::_('COM_VIRTUEMART_CART_TOTAL') ?></th>
</tr>
</thead>
<!-- End heading -->
<?php
    ...
    <tr class="product-hover soft-hide">
        <td colspan="4">
            <div class="<?php echo $class; ?>-arrow-box">
                <table class="<?php echo $class; ?>-p-info-table" style="width: 245px;">
                    <tbody>
                    <tr>
                        <td colspan="2">
                            <div class="<?php echo $class; ?>-product-image">
                                <div class="p-info-inner">
                                    <img class="img-reponsive" alt="image1xxl83" src="/joomla/zt_colinus_quickstart/images/stories/virtuemart/product/resized/image1xxl83_262x334.jpg">										</div>
                            </div>
                            <div class="<?php echo $class; ?>-p-info">
                                <div class="p-info-inner">
                                    <div class="<?php echo $class; ?>-product-name">
                                        <a href="/joomla/zt_colinus_quickstart/index.php/en/products/rheumatic-drugs11-6-detail">Cephalexin</a><div class="vm-customfield-cart"></div>											</div>
                                </div>
                            </div>
                    ...
                    <tr class="add-padding add-padding-top">
                        ...
                        <td align="right" width="65%" class="col-price nowrap">
                            <span class="PricediscountedPriceWithoutTax">$202.70</span>
                        </td>
                    </tr>
                    <tr class="add-padding add-padding-bottom">
                        <td width="35%">Total</td>
                        <td align="right" width="65%" class="col-total-price nowrap">
                            <div class="PricesalesPrice vm-display vm-price-value"><span class="vm-price-desc"></span><span class="PricesalesPrice">$810.82</span></div>							</td>
                    </tr>
                    </tbody></table>
            </div>
        </td>
